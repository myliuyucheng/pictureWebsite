...
<script>
import { getArticleList,getAcategoryList,getUserList,deleArticle } from "@/api"
...
export default {
    methods: {
        ...
        edits(index,value){
            this.$router.push({name:'ArticlesBox',params:{_id:value._id}})
