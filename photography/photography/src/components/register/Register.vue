<template>
    <div class="register">
        <div class="regbox">
            ...
            <div class="regform">
                <div class="inputbox">
                    <div style="width:50px;height:50px;border-radius:50%;border:1px solid rgb(64,158,255);overflow:hidden" ref="img"></div>
    ...
    methods: {
        ...
        async register(){
            ...
            if(this.check.every(value=>value)){
                this.param.append("name",this.name)
                this.param.append("username",this.username)
                this.param.append("password",this.password)
                let data = await register(this.param)
                this.error = ""
        ...
        nameCheck(){
            ...
            if(name.length === 0){
                ...
                return this.nameError = "用户名长度不能超过15个字符"
            }
            this.check[0] = true
