    ...
    <div class="add-article">
        ...
        <div class="art-right">
            <div class="art-right-body">
                ...
                <div @click="submit" class="button databody">发布文章</div>
            </div>
        </div>
...
<script>
import Wangeditor from "./base/wangeditor"

import Errorbox from "@/common/ErrorBox"
import Successbox from "@/common/SuccessBox"
import { addArticle,getAcategory } from "@/api"
export default {
    data() {
        return {
            title: "",
    ...
    methods:{
        ...
        async submit(){
            ...
            let data = await addArticle({title,description,content,category})
            if(data.code == 0){
                console.log("上传成功")
